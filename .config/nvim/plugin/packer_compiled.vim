...
-- Command lazy-loads
vim.cmd [[command! -nargs=* -range -bang -complete=file LaunchVimspector lua require("packer.load")({'vimspector'}, { cmd = "LaunchVimspector", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]]
